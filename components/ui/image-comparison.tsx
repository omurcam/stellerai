...
const ImageComparisonImage = ({
  ...
  const leftClipPath = useTransform(motionSliderPosition, (value: number) => `inset(0 ${100 - value}% 0 0)`);
...
const ImageComparisonSlider = ({
  ...
  return (
    <motion.div
      className={cn("absolute top-0 bottom-0 -translate-x-1/2 w-1 cursor-ew-resize", className)}
      style={{
        left
      }}>
      {children}
